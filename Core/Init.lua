...
local defaults = {
    profile = {
        ...
        -- 功能8：聊天频道条（posX/posY 为相对屏幕中心的偏移，默认左下角附近）
        ...
        -- 功能11/14：鼠标提示扩展（合并大秘境信息+团本进度+人物提示增强；showIDs = 各类 ID 显示）
        tooltipEnhance  = { enabled = true, showIDs = true },
        ...
        bigWigsEnhance  = { enabled = true,
            ...
            posX = 0, posY = 0,
            spacing = 8,
            nameFontSize = 22, countFontSize = 26, iconSize = 30,
