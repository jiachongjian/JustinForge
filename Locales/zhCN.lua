...
L["TooltipEnhance_Desc"] = "增强鼠标提示框：姓名按职业染色、隐藏头衔、同服隐藏服务器名、显示<离开><忙碌><离线>状态；公会行显示<公会名>[会阶]；等级行隐藏\"等级\"字样、数字黄色，专精职业行按职业染色；追加显示M+分数/史诗钥匙/物品等级(套装数/5)、各地下城限时成绩、当前赛季团本进度、目标的目标；可在物品/法术/货币/玩具/宠物/任务提示框最后一行显示对应 ID。不修改任何字体样式。"
L["TooltipEnhance_ShowIDs"] = "显示各类 ID"
L["TooltipEnhance_ShowIDsTip"] = "在物品、法术（含光环）、货币、玩具、宠物、任务等鼠标提示框的最后一行显示对应的 ID（仅限暴雪原生提示框）。"
L["TE_MPScore"] = "M+ 分数"
