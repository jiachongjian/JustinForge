...
L["TooltipEnhance_Desc"] = "增强鼠标提示框：姓名按职业染色、隐藏头衔、同服隐藏服务器名、显示<离开><忙碌><离线>状态；公会行显示<公会名>[会阶]；等级行隐藏\"等级\"字样、数字黄色，专精职业行按职业染色；追加显示M+分数/史诗钥匙/物品等级(套装数/5)、各地下城限时成绩、当前赛季团本进度、目标的目标。不修改任何字体样式。"
L["TE_MPScore"] = "M+ 分数"
...
-- 模块19：装备错误提醒（独立子分类页面）
L["EA_Name"] = "装备错误提醒"
L["EA_Desc"] = "检测到明显的装备错误时在屏幕上显示白色文字提醒（战斗中自动隐藏，脱战恢复），多条提醒以设定位置为顶部向下堆叠。检测内容：1) 已学习工程学但未装备腰带，或腰带未附魔「氮气推进器」；2) 未装备主手武器，或主手为单手武器（含魔杖）时副手为空，或双持专精副手未装备武器；3) 武器主属性与当前专精不符；4) 刺杀/敏锐贼未双持匕首；5) 奶骑/防护骑/防护战未使用单手武器+盾牌；6) 生存猎未装备双手近战武器；7) 兽王/射击猎未装备远程武器（弓/枪/弩）。"
L["EA_PosX"] = "水平位置 (X)"
L["EA_PosY"] = "垂直位置 (Y)"
L["EA_PosTip"] = "提醒的显示位置（以屏幕中心为原点，左/下为负，右/上为正），多条提醒从该位置向下堆叠。"
L["EA_FontSize"] = "字号"
L["EA_FontSizeTip"] = "提醒文字的字号（颜色固定为白色）。"
L["EA_NoBelt"] = "氮气推进器"
L["EA_NoNitro"] = "氮气推进器"
L["EA_NoMainHand"] = "主手缺失"
L["EA_NoOffHand"] = "副手武器"
L["EA_NoOffHandItem"] = "副手缺失"
L["EA_NeedShield"] = "盾牌缺失"
L["EA_NeedOneHand"] = "武器错误"
L["EA_NeedMelee2H"] = "武器错误"
L["EA_NeedRanged"] = "武器错误"
